...
framework, or allocate work on startup. Independent pane tab groups are retained
in the bounded session graph, and dirty text is protected by the private
recovery journal described below. Conflict-resolution commands and file-tree
expansion restoration remain unimplemented parts of Task #127.
