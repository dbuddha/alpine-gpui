...
use super::{Buffer, BufferSnapshot, ByteOffset, Composition, EditorRenderError};
use std::ops::Range;
...
) -> Result<Vec<(f32, f32)>, EditorRenderError> {
...
impl Projection {
    ...
    pub fn line(&self, display: usize) -> Result<Line<'_>, EditorRenderError> {
    ...
    pub fn line_at_utf16(&self, index: usize) -> Result<Line<'_>, EditorRenderError> {
...
mod tests {
    ...
    #[test]
    fn replacing_a_large_span_retains_only_boundary_text() -> Result<(), EditorRenderError> {
