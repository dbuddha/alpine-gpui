...
| CPU pixel oracle plus versioned traces | Semantic admission is independent of Metal and comparator adapters | Eight-fixture and six-step lifecycle E3 CPU, Alpine Direct Metal, and pinned GPUI Metal admission through PRs #344 and #469 | Timing, adaptation, residency, and E4 qualification remain under #470-#472 |
