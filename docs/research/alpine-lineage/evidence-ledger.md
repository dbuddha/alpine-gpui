...
| ALG-014 | CPU oracle and versioned trace | Comparator methodology, `ALPINE-ORIGINAL`, E2 | Independent semantic image plus workload/hash identity | Solid-quad Alpine and Zed lab reproduction; E3 only for that workload | No glyph, code viewport, scroll, resize, timing, or memory claim |
| ALG-015 | Event-to-present correlation | Apple timestamps and profiling practice, `INDEPENDENT-CONVERGENCE`, E2 | Event, submission, completion, presented-handler stages plus signposts | PR #307 and #312 deterministic evidence; external capture not retained | Diagnostic-only; Task #314 and defect #304 block latency claims |
...
| ALS-009 | Native accessibility transport | AppKit/AX requirement, `INDEPENDENT-CONVERGENCE`, E2 | Bounded semantics, text mappings, actions, notifications, destruction | Snapshot/native model tests; Alpine E3 | Physical VoiceOver and AXObserver evidence #253/#272/#273 open |
| ALS-010 | Stable local app bundle | macOS product requirement, `INDEPENDENT-CONVERGENCE`, E1 | Revision-pinned assembly and explicit recovery launch | PR #306 and #313 implementation evidence | Issue #303 is stale/open; launch is not daily-driver qualification |
