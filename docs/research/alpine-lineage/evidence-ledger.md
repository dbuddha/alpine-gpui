...
| ALS-008 | Bounded local LSP transport | LSP/JSON-RPC and Zed project behavior, `INDEPENDENT-CONVERGENCE`, E2 | One local child process, bounded framing/state, revision-tagged results, and canonical workspace-confined source navigation | Mock protocol, malformed input, lifecycle, pinned rust-analyzer tests, PR #345 exact-head run `32762895848`, and merge `7db5e18f6da8e02cd171668d4714c745c55d7eda`; Alpine E3 | Diagnostics, completion, hover, definition, and references implemented; rename/formatting #220 and symbols #221 remain |
