...
| ALG-014 | CPU oracle and versioned trace | Comparator methodology, `ALPINE-ORIGINAL`, E2 | Immutable v1 solid-quad control, v2 prepared scenes, and a separate bounded lifecycle companion for atlas reuse, replacement, teardown, and full resynchronization | PR #343, Alpine Zed Lab PRs #5 and #6, exact `assurance/lab/v2` and `assurance/lab/v3` records, Task #353 sequence property and Kani evidence, merged-main hosted assurance, and final-revision physical Direct Metal reproduction | Eight prepared scenes and the six-step atlas lifecycle are composed E3; timing, memory, independent windows, and E4 remain Requirement #53 work |
...
| ALS-008 | Bounded local LSP transport | LSP/JSON-RPC and Zed project behavior, `INDEPENDENT-CONVERGENCE`, E2 | One local child process, bounded framing/state, revision-tagged diagnostics, completion, navigation, symbols, and strict workspace-confined edit preparation | Mock protocol, malformed input, lifecycle, pinned rust-analyzer tests, PR #345 exact-head run `32762895848` and merge `7db5e18f6da8e02cd171668d4714c745c55d7eda`, PR #348 exact-head run `32783789659` and merge `e2564055622dce3a7d1f277d52fc53e34c16e916`, and merged symbol work in PR #350 at `bce93b5dbec334a0b9c50d00aeb04d1cb7aad3ac`; Alpine E3 for merged behavior | Diagnostics, completion, hover, definition, references, and bounded document/workspace symbols are merged at E3. Local #220 work implements preview, atomic checksummed three-phase publication, fail-closed rollback/startup recovery, loaded-tab admission, and active undo. The exact `2026-08-17.4` rust-analyzer (`0.3.3016-standalone`, SHA-256 `ece932daf2f077be87bf745d2eb0a62cbc550f4b1e2e31ca76dfafdd0cc599b3`) locally passes `lsp_client::tests::pinned_rust_analyzer_qualifies_real_document_lifecycle`, including real rename and formatting responses admitted and prepared by Alpine. Task #220 remains unqualified until this exact-head path and the complete fault-injection, mutation, and coverage evidence pass hosted CI and are retained. |
...
- ALG-014: prepared-scene and atlas-lifecycle E3 to calibrated timing, memory, independent windows, and E4 paired GPUI qualification under #53.
