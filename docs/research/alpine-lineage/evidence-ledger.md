...
| ALS-008 | Bounded local LSP transport | LSP/JSON-RPC and Zed project behavior, `INDEPENDENT-CONVERGENCE`, E2 | One local child process, bounded framing/state, revision-tagged diagnostics, completion, navigation, symbols, and strict workspace-confined edit preparation | Mock protocol, malformed input, lifecycle, pinned rust-analyzer tests, PR #345 exact-head run `32762895848` and merge `7db5e18f6da8e02cd171668d4714c745c55d7eda`, PR #348 exact-head run `32783789659` and merge `e2564055622dce3a7d1f277d52fc53e34c16e916`, and merged symbol work in PR #350 at `bce93b5dbec334a0b9c50d00aeb04d1cb7aad3ac`; Alpine E3 for merged behavior | Diagnostics, completion, hover, definition, references, and bounded document/workspace symbols are merged at E3. Local #220 work implements preview, atomic checksummed three-phase publication, fail-closed rollback/startup recovery, loaded-tab admission, and active undo, but remains unqualified until exact-head CI, fault injection, mutation, coverage, and pinned rust-analyzer evidence are retained. |
